  ...
  const renderSection = (sec) => {
    ...
    switch (key) {
      ...
      case "featured_products":
        return <ProductSection key={key} title={customTitle || "Sản Phẩm Bán Chạy"} products={featured_products} columns={5} limit={sec.limit || 8} isSlider showSoldCount showSale={false} />;
      case "trust_badges":
