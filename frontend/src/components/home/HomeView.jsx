  ...
  const renderSection = (sec) => {
    ...
    switch (key) {
      ...
      case "featured_products":
        return <ProductSection key={key} title={customTitle || "Sản Phẩm Bán Chạy"} products={featured_products} columns={5} hasLoadMore showSoldCount showSale={false} initialCount={5} loadMoreStep={5} />;
      case "trust_badges":
