...
<div class="dashboard-header" style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center;">
    <div class="header-title-block">
        <div style="font-size: 0.76rem; font-weight: 700; color: var(--text-muted); margin-bottom: 6px;">Quản lý / Bài viết / Thêm mới</div>
        <h1 style="font-size: 1.85rem; font-weight: 800; color: var(--text-main);">Viết bài viết mới</h1>
        <p style="color: var(--text-muted); margin-top: 4px;">Tạo tin tức, cẩm nang chăm sóc và khuyến mãi cho PetWorld.</p>
    </div>
...
<form id="post-create-form" action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            <div class="form-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-input" value="{{ old('title') }}" placeholder="Nhập tiêu đề hấp dẫn, chuẩn SEO..." required>
                ...
                <div class="form-group" style="margin-bottom: 24px;">
                    ...
                    <textarea id="description" name="description" class="form-textarea" placeholder="Tóm tắt ngắn gọn nội dung chính bài viết (hiển thị trên thẻ bài viết bên ngoài trang chủ)..." maxlength="500" required>{{ old('description') }}</textarea>
        ...
        <div style="display: flex; flex-direction: column; gap: 24px; position: sticky; top: 20px;">
            ...
            <div class="form-card">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <select id="status" name="status" class="form-select" required>
                        <option value="active" @selected(old('status', 'active') === 'active')>Xuất bản (Active)</option>
                        <option value="inactive" @selected(old('status') === 'inactive')>Lưu nháp (Inactive)</option>
                    </select>
            ...
            <div class="form-card">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    <div class="image-upload-card" onclick="document.getElementById('image').click()">
                        <input type="file" id="image" name="image" accept="image/*" style="display: none;" onchange="previewImage(this)" required>
                        
                        {{-- Placeholder --}}
                        <div id="upload-placeholder" class="upload-placeholder">
                            <i class="fa-solid fa-cloud-arrow-up"></i>
                            <span style="font-size: 0.88rem; font-weight: 700; color: #2d2926;">Tải ảnh bìa lên</span>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 8px;">
                <button type="submit" class="btn-dark-slate" style="width: 100%; padding: 14px; border-radius: 30px; font-weight: bold; font-size: 0.95rem; border: none; background: var(--primary); color: #fff; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 15px rgba(255, 120, 45, 0.25); display: inline-flex; align-items: center; justify-content: center; gap: 6px;" onmouseover="this.style.background='var(--primary-hover)'" onmouseout="this.style.background='var(--primary)'">
                    <i class="fa-solid fa-circle-check"></i> Lưu & Xuất bản
                </button>
