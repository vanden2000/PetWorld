            ...
            <div class="layout-column-sidebar">
                ...
                <div class="form-card">
                    <div class="form-card-title">
                        ...
                        <span>Hình Ảnh <small id="image-count" style="color: var(--theme-text-gray); font-weight: 600;"></small></span>
                    </div>
                    ...
                    <div class="image-alt-editor">
                        ...
                        <textarea id="image-alt-text" class="input-text-field" maxlength="255" disabled placeholder="Chọn một ảnh để thêm mô tả SEO"></textarea>
